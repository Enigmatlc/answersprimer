...
public:
	...
	//functions
	std::set<StrBlob::size_type>::iterator; begin() const { return q_numbers->begin(); }
	std::set<StrBlob::size_type>::iterator; end() const { return q_numbers->end(); }
	shared_ptr<StrBlob> get_file() const { return q_line; }
private:
	std::string q_word;
